        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @else
                ...
                <div wire:key="card-{{ $currentIndex }}"
                     ...
                     style="perspective: 1200px; min-height: 280px;"
                    ...
                    <div class="relative w-full transition-transform duration-500"
                        ...
                        {{-- Front — Question --}}
                        <div class="absolute inset-0 bg-white shadow-md rounded-xl p-8 flex flex-col items-center justify-center text-center"
                        ...
                        {{-- Back — Answer --}}
                        <div class="absolute inset-0 bg-indigo-600 shadow-md rounded-xl p-8 flex flex-col items-center justify-center text-center"
